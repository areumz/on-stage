      ...
      <div className="flex flex-col gap-3 px-8 py-4">
        <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
            <span className="whitespace-nowrap rounded-full border border-white/20 px-4 py-1.5 text-sm text-white/80">
              {metrics.nextShow.venue} 셋업
            </span>
            <span className="shrink-0 whitespace-nowrap text-xs text-white/50">{roleLabel}</span>
            <TabToggle dark />
          </div>
        </div>
